...
public class ContactsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ContactsPackage.CONTACTS_CONTAINER: {
				ContactsContainer contactsContainer = (ContactsContainer)theEObject;
				T result = caseContactsContainer(contactsContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseContactsContainer(ContactsContainer object) {
		return null;
	}
